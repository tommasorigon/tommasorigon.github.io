...
\begin{itemize}
\item \emph{PhD in Statistics and Computer Science} at Bocconi University (Patric Dolmeta, 2024)
\item \emph{Ph.D. in Economics and Statistics} at the University of Milano-Bicocca (Camilla Salvatore, Luca Brusa, 2023)
...
\begin{outerlist}
\item \textbf{Current Ph.D. students}: Luca Presicce (\textbf{Ph.D.}), Davide Agnoletto (\textbf{M.Sc.}, \textbf{Ph.D.}, supervisor: Bruno Scarpa), Riccardo Cogo (\textbf{Ph.D.}, supervisor: Federico Camerlenghi),  Ching-Lung Hsu (\textbf{Ph.D.}, supervisor: David Dunson)
\item \textbf{Former Ph.D. students}: Alessandro Zito (\textbf{Ph.D.}, supervisor: David Dunson, 2024)
...
\section{Funding and grants}  \textbf{Member of the research group} of the \textsc{nemesis erc} project entitled ``\emph{sociogeNEsis of criMinal nEtworks: reconStruction, dIscovery and diSruption}'', funded by the European Research Council \textsc{erc} starting grant for the years 2024-2029.  \textsc{pi}: Daniele Durante  \\
...
\item Anceschi, N., \textbf{Rigon, T.}, Zanella, G., and Durante D. (2024+).  Optimal lower bounds for logistic log-likelihoods. Submitted, \emph{arXiv:2410.10309}

\item Ghilotti, L., Camerlenghi, F., and \textbf{Rigon, T.} (2024+). Bayesian analysis of product feature allocation models. Submitted, \emph{arXiv:2408.15806}
...
\item[] As lecturer
\begin{innerlist}
\item \href{https://tommasorigon.github.io/CompStat/}{Bayesian Computations} (Ph.D.) A.Y. 2020/21, 2021/22 - 12h - 2022/23, 2023/24 - 15h
