...
- This distribution can be employed to build a novel generalized linear model (GLM), which automatically incorporates [heteroskedasticity]{.orange} and exhibits [heavier tails]{.blue} than the Gaussian law.
