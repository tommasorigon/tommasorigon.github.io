...
subtitle: "Università of Milano-Bicocca"
date: "2026-06-09"
description: "A joint work with [Alessandro Zito]{.orange}, [Ching-Lung Hsu]{.blue}  et al. presented at the University of Milano-Bicocca." 
lang: en
...
format:
  html:
    toc: true
  revealjs:
    output-file: hubbel_slides.html
format-links: true
---
...
![](img/Timeline.jpg){.nostretch fig-align="center" width=85%}


## Approximately 80 years ago... @Fisher1943

![](img/Timeline_Fisher2.jpg){.nostretch fig-align="center" width=85%}

## Early ideas [@Good_1953; @Good_Toulmin_1956]

![](img/Timeline_good.jpg){.nostretch fig-align="center" width=85%}

## The Ewens sampling formula @ewens72

![](img/Timeline_Ewens2.jpg){.nostretch fig-align="center" width=85%}

## The Dirichlet process [@Ferguson1973]

![](img/Timeline_DP2.jpg){.nostretch fig-align="center" width=85%}

## ... and species sampling models [@Pitman1996]

![](img/Timeline_Pitman2.jpg){.nostretch fig-align="center" width=85%}


## Ewens formula governs the neutral theory! [@Hubbell_2001]

![](img/Timeline_Hubbell2.jpg){.nostretch fig-align="center" width=85%}


## All ties together [@McCullagh_2016]

![](img/Timeline_McCullagh2.jpg){.nostretch fig-align="center" width=85%}
...
- Broadly speaking, the $\sigma$-diversity can be seen as a [rescaled richness measure]{.orange}. 

- The $\sigma$-diversity is deterministic and assumed to be known in the [Dirichlet multinomial]{.orangee}, [Dirichlet process]{.blue}, and [$\sigma$-stable PK]{.grey}. 
...
- The [posterior law]{.blue} of the $\sigma$-diversity is a key quantity for measuring [biodiversity]{.orange}. The posterior law of $S_\sigma$ has an elegant connection with accumulation curves.
...
$$
as $m \rightarrow \infty$, where $S_\sigma$ is the [$\sigma$-diversity]{.blue}.
:::

## Tree species in the Amazon Basin [@Hubbell2008]

::: columns

::: {.column width="40%"}
![](img/sites.jpg){width="100%"}
:::

::: {.column width="60%"}
![](img/alpha.jpg){width="100%"}
:::

:::

- How to get a [Bayesian]{.blue} estimator for the biodiversity? We can place a [prior]{.orange} on $\alpha$ and the compute its [posterior distribution]{.blue} using Bayes theorem. 

- [Posterior distribution]{.orange} of the $\sigma$-diversity $\alpha$, under a (conjugate) Stirling-gamma prior [@Zito2024]. The dotted lines represent 95% credible intervals. The dashed line is the posterior mean.


## Historical summary and extensions

- The fundamental biodiversity number $\alpha$ is a [growth-adjusted richness]{.blue}:
$$
...
- There are a lot of possible extensions. This is a very [biased]{.orange} list:
  - The choice $\sigma \in (0, 1)$ allows for polynomial growth [@Pitman1997; @Lijoi2007b] while $\sigma < 0$ leads to a finite richness [@Gnedin2010; @Lijoi2020].
  - Multiple samples, a.k.a. [partial exchangeability]{.blue}  [@Camerlenghi_2019; @franzolini2025]
  - Enriched processes, taxonomical data [@Zito2023c; @Rigon2025b; @Rigon2025].
  - Incidence data and [feature models]{.orange} [@Ghilotti2025].
  - What about [covariates]{.orange}?
...
2. Numerically retrieve the diversity $\alpha_i$ and compute variances: $$
   \alpha_i^{(t)} \gets 
...
4. Update the [regression coefficients]{.blue}:  
...
## Summary and future directions II
