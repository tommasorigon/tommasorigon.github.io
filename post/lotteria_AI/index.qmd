...
Questo fraintendimento nasce da un [errore di interpretazione]{.blue} della probabilità[^LGN]. Anche se un numero non è stato estratto per molto tempo, la probabilità che esca al prossimo sorteggio rimane invariata, ovvero $1/90$. Questo proprio perché le estrazioni sono [indipendenti]{.blue} le une dalle altre.
:::
...
Questi concetti dovrebbero essere ben noti agli studenti di statistica e da docente di statistica, trovo [sconfortante]{.blue} che un fraintendimento così elementare provenga proprio da studenti universitari di matematica e fisica.
