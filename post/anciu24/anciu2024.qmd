...
#| fig-width: 8
#| fig-height: 4
ggplot(data = gigante_m, aes(x = Categoria, y = Tempo, fill = Categoria)) + geom_boxplot(outlier.size = 0, outlier.alpha = 0) + geom_jitter(width = 0.15, size = 0.5) + theme_light() + theme( legend.position = "none") + ylab("Tempo (secondi)") + xlab("Categoria (A,B,C,D)") + scale_fill_tableau(palette = "Tableau 20")
```
:::
