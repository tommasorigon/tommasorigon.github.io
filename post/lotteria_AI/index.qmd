...
La prima conseguenza di queste assunzioni è che, nel lungo periodo, la frequenza delle estrazioni di ciascun numero sarà approssimativamente $1/90$. Di conseguenza, [non ha senso]{.orange} basare le proprie scelte sui numeri usciti più di frequente, come fatto dai tre studenti, apparentemente su suggerimento del loro tabaccaio. Eventuali discrepanze nelle frequenze empiriche dei singoli numeri sono [oscillazioni casuali prive di significato]{.blue}.
...
Un aspetto controintuitivo della vicenda riguarda il fatto che vincere 50.000 euro è un evento piuttosto raro. Questo porta ad un altro tipico [fraintendimento]{.orange}: *"Poiché l'evento è raro, non può essere stato un caso! Come avrebbero fatto i 3 studenti, altrimenti?"*. In realtà, gli [eventi rari accadono ogni giorno]{.blue}; altrimenti, nessuno vincerebbe mai il Superenalotto.  
