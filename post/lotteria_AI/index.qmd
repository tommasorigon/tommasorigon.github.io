...
Dopotutto, se fosse davvero possibile prevedere i numeri del lotto, ciò implicherebbe accusare lo Stato italiano di incompetenza o addirittura di frode. Un precedente famoso è descritto qui nel seguito.
:::
...
Un aspetto controintuitivo della vicenda riguarda il fatto che vincere 50.000 euro è un evento piuttosto raro. Questo porta ad un altro tipico [fraintendimento]{.orange}: *"Poiché l'evento è raro, non può essere stato un caso!"*. In realtà, gli eventi rari accadono ogni giorno; altrimenti, nessuno vincerebbe mai il Superenalotto.  
...
Si veda anche il video YouTube divulgativo: [*Statistician Answers Stats Questions From Twitter*](https://www.youtube.com/watch?v=QW3KRaz4aI4&t=605s) di WIRED.
