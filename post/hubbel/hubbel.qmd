...
date: "2026-06-09"
description: "A joint work with [Alessandro Zito]{.orange} et al. presented at the University of Milano-Bicocca." 
lang: en
...
- We estimate $\hat{\sigma} = 0.53$ via maximum likelihood, which amounts to a [square root growth]{.orange}.  

- P-values are corrected for shared species via the [sandwich estimator]{.blue}.  
...
## Results: latitude has a major effect!

![](img/Results.jpg){.nostretch fig-align="center" width=75%}
